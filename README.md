...
[test-image]: https://github.com/stdlib-js/napi-argv-strided-int8array/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/napi-argv-strided-int8array/actions/workflows/test.yml?query=branch:v0.1.1
